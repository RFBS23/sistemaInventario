...
go
select * from ventastienda where numerodocumento = '00002'
go
...
select p.nombre + ' ' + p.descripcion + ' ' + p.colores + ' ' + tr.nombretalla as productos, dv.precioventa, dv.cantidad, dv.subtotal from detalle_venta dv
...
where vt.numerodocumento = '00001'

select pt.idproductotienda, dvt.precioventa, dvt.cantidad, dvt.subtotal from detalle_ventatienda dvt
inner join productosropatienda pt on pt.idproductotienda = dvt.idproductotienda
where dvt.idventatienda = '00001'
